...
public ResponseEntity<Object> getAllBookedService() {
	Response response = customerService.getAllBookedService();
	if(response != null && response.getData() == null) {
		 return ResponseEntity.status(response.getStatus()).body(response);
	 }else if(response != null && response.getData() != null) {
		 return ResponseEntity.status(response.getStatus()).body(response.getData());}
...
public ResponseEntity<Response> getRatingInfo(@PathVariable String hospitalId, @PathVariable String doctorId) {
   ...
   //GETSUBSERVICE DETAILS BY SUBSERVICEID
   
   @GetMapping("/getSubServiceInfo/{subServiceId}")
   public ResponseEntity<Response> getSubServiceInfoBySubServiceId(@PathVariable String subServiceId)throws JsonProcessingException{
   ...
   public ResponseEntity<Response> getDoctorsAndClinicDetails(@PathVariable String hospitalId,
   ...
   public ResponseEntity<Response> getDetailsBySubServiceIdAndConsultationType(@PathVariable String subServiceId){
	  Response response= customerService.getDetailsBySubServiceIdAndConsultationType(subServiceId);
	  if(response != null) {
			 return ResponseEntity.status(response.getStatus()).body(response);}
			 else {
				 return null;
