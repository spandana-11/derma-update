...
//	        response.setData(errors);
	...
	// ----------Get doctor by ID. @PathVariable id Doctor ID @return Doctor details----------------
...
//		--------------------Get Doctors by ClinicID and DoctorId---------------------
	...
	//----------------Get Doctors by their Clinic ids--------------------------------------------------
...
//		------------------Get Doctors by hopital id and subServiceId----------------------------------------------------------------------------------------
	...
	/* ------------------------------------------------------------------------------------------------------------------------------
		...
		public ResponseEntity<Response> addDoctorSlot(@PathVariable String hospitalId,@PathVariable String doctorId, @RequestBody DoctorSlotDTO slotDto) {
	...
	//--------------------------delete slot by using time date doctorId-----------------------------------------------------
	...
	//----------------------------------------delete doctor slot by date-------------------------------------------------
		...
		public boolean updateDoctorSlot(@PathVariable String doctorId,@PathVariable String date,
